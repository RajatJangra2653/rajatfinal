...
$task = New-ScheduledTask -Trigger $trigger -Description "Run PowerShell script on user logon"
Register-ScheduledTask -TaskName ABC -TaskPath $task -Action $action -Force